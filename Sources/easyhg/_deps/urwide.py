...
# Last mod  : 09-Feb-2008
# -----------------------------------------------------------------------------

import sys, string, re, curses
try:
	import urwid
	import urwid.raw_display as urwid_raw_display
	import urwid.curses_display as urwid_curses_display
except:
	from _deps import urwid
	import _deps.urwid.raw_display as urwid_raw_display
	import _deps.urwid.curses_display as urwid_curses_display
...
class Console(UI):
	...
	def main( self ):
		...
		your application."""
		#self._ui = urwid_curses_display.Screen()
		self._ui  = urwid_raw_display.Screen()
		self._ui.clear()
